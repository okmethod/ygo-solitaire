/**
 * PotOfGreedActivation Tests
 *
 * Tests for PotOfGreedActivation ChainableAction implementation.
 *
 * Test Coverage:
 ...
 *
 * @module tests/unit/domain/effects/chainable/PotOfGreedActivation
 */
...
describe("PotOfGreedActivation", () => {
  const action = new PotOfGreedActivation();
