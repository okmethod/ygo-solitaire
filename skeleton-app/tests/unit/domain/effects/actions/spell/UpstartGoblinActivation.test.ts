/**
 * UpstartGoblinActivation Tests
 *
 * Tests for UpstartGoblinActivation ChainableAction implementation.
 *
 * Test Coverage:
 ...
 *
 * @module tests/unit/domain/effects/chainable/UpstartGoblinActivation
 */
...
describe("UpstartGoblinActivation", () => {
  const action = new UpstartGoblinActivation();
