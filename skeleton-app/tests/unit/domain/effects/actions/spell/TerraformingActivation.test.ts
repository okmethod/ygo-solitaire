/**
 * TerraformingActivation Tests
 *
 * Tests for TerraformingActivation ChainableAction implementation.
 *
 * Test Coverage:
 ...
 *
 * @module tests/unit/domain/effects/chainable/TerraformingActivation
 */
...
describe("TerraformingActivation", () => {
  const action = new TerraformingActivation();
