/**
 * CardDestructionAction Tests
 *
 * Tests for CardDestructionAction ChainableAction implementation.
 *
 * Test Coverage:
 ...
 *
 * @module tests/unit/domain/effects/chainable/CardDestructionAction
 */
...
describe("CardDestructionAction", () => {
  const action = new CardDestructionAction();
