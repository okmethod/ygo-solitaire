/**
 * GracefulCharityAction Tests
 *
 * Tests for GracefulCharityAction ChainableAction implementation.
 *
 * Test Coverage:
 ...
 *
 * @module tests/unit/domain/effects/chainable/GracefulCharityAction
 */
...
describe("GracefulCharityAction", () => {
  const action = new GracefulCharityAction();
