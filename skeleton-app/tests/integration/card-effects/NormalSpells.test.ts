    ...
    it("Scenario: Activate Dark Factory → Select 2 monsters from graveyard → Add to hand", () => {
      ...
      const state = createMockGameState({
        ...
        zones: {
          ...
          field: [],
          graveyard: [
            { id: 1001, instanceId: "grave-0", type: "monster", frameType: "normal", jaName: "モンスター1", location: "graveyard" },
            { id: 1002, instanceId: "grave-1", type: "monster", frameType: "normal", jaName: "モンスター2", location: "graveyard" },
            { id: 1003, instanceId: "grave-2", type: "monster", frameType: "normal", jaName: "モンスター3", location: "graveyard" },
          ],
          banished: [],
        },
      });
  ...
  describe("Terraforming (73628505) - Scenario Tests", () => {
    ...
    it("Scenario: Activate Terraforming → Select Field Spell from deck → Add to hand", () => {
      ...
      const state = createMockGameState({
        ...
        zones: {
          deck: [
            { id: 1001, instanceId: "deck-0", type: "monster", frameType: "normal", jaName: "モンスター1", location: "deck" },
            { id: 67616300, instanceId: "deck-1", type: "spell", frameType: "spell", jaName: "チキンレース", spellType: "field", location: "deck" },
            { id: 1002, instanceId: "deck-2", type: "monster", frameType: "normal", jaName: "モンスター2", location: "deck" },
          ],
