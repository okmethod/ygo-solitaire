...
export const CONDITION_NAMES = {
  ...
  DECK_HAS_NORMAL_MONSTER_FOR_GRAVEYARD_BANISH: "DECK_HAS_NORMAL_MONSTER_FOR_GRAVEYARD_BANISH",
  ...
  GRAVEYARD_HAS_SPELL_OR_TRAP: "GRAVEYARD_HAS_SPELL_OR_TRAP",

  // フィールド関連
  FIELD_HAS_CARD: "FIELD_HAS_CARD",
  FIELD_HAS_EQUIPPED_NAME_INCLUDES: "FIELD_HAS_EQUIPPED_NAME_INCLUDES",
  FIELD_HAS_MONSTER_WITH_RACE: "FIELD_HAS_MONSTER_WITH_RACE",
  FIELD_HAS_NON_EFFECT_MONSTER: "FIELD_HAS_NON_EFFECT_MONSTER",
