 ...
 * - RESOLUTIONS: 効果解決後に墓地に送られる
 *
 * @module domain/effects/actions/activations/QuickPlaySpellActivation
 */
...
import { sendToGraveyardStep } from "$lib/domain/dsl/steps/builders/discards";
