/**
 * ContinuousSpellActivation - 永続魔法カード発動の抽象基底クラス
 *
 * BaseSpellActivation を拡張し、永続魔法に共通するプロパティとメソッドを提供する。
 *
 ...
 *
 * @module domain/effects/actions/activations/ContinuousSpellActivation
 */
...
/**
 * ContinuousSpellActivation - 永続魔法カードの抽象基底クラス
 *
 * @abstract
 */
export abstract class ContinuousSpellActivation extends BaseSpellActivation {
  /** スペルスピード1（永続魔法） */
